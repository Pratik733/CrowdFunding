      ...
      <CardsWrapper>
        ...
        {filter.map((e) => {
          return (
            <Card key={e.title}>
              <CardImg>
                <Image className="h-32 rounded-t-3xl"
                  alt="test crowdfunding dapp"
                  layout="fill"
                  src={
                    "https://testcrowdfunding.infura-ipfs.io/ipfs/" + e.image
                  }
                />
              </CardImg>
              <Title>{e.title}</Title>
              <CardData className="flex items-center border-b border-sky-500 py-2">
                <Text>
                  Owner
                  <AccountBoxIcon />
                </Text>
              ...
              <Link passHref href={"/" + e.address} className="mt-3">
